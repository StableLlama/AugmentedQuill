...
from app.helpers.sourcebook_helpers import sb_create, sb_get, sb_search, sb_delete
...
class SourcebookTest(TestCase):
    def setUp(self):
        ...
        # But wait, app.projects.get_active_project_dir uses AUGQ_PROJECTS_REGISTRY
